...
sshpass -p 'ATV-R0tana2020' scp /home/sysadm/mikrotik/${HOST}/intermediaries.crt ${MTUSER}@${MTADDR}:/intermediaries.crt >/dev/null 
sshpass -p 'ATV-R0tana2020' scp /home/sysadm/mikrotik/${HOST}/${HOST}.crt ${MTUSER}@${MTADDR}:/${HOST}.crt >/dev/null
sshpass -p 'ATV-R0tana2020' scp /home/sysadm/mikrotik/${HOST}/${HOST}.key ${MTUSER}@${MTADDR}:/${HOST}.key >/dev/null
 
sshpass -p 'ATV-R0tana2020' ssh -T ${MTUSER}@${MTADDR} <<EOF >/dev/null
:delay 3
